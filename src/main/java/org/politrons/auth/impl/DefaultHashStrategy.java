...
public class DefaultHashStrategy implements HashStrategy {
   ...
   * (non-Javadoc)
   * 
   * @see io.vertx.ext.auth.auth.HashStrategy#computeHash(java.lang.String, io.vertx.ext.auth.User)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.vertx.ext.auth.auth.HashStrategy#getStoredPwd(io.vertx.ext.auth.User)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.vertx.ext.auth.auth.HashStrategy#getSalt(io.vertx.ext.auth.User)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.vertx.ext.auth.auth.HashStrategy#setSaltStyle(io.vertx.ext.auth.auth.HashStrategy.SaltStyle)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.vertx.ext.auth.auth.HashStrategy#getSaltStyle()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see io.vertx.ext.auth.auth.HashStrategy#setExternalSalt(java.lang.String)
   */
  @Override
